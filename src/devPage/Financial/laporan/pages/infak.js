        ...
        <React.Fragment>
            <div className="page-content">
                <div className="container-fluid">
                    <Breadcrumbs title="LPD Infak" breadcrumbItem="Laporan Perubahan Dana Infak" />
                    <Card>
                        <CardBody className="border-bottom">
                            <div className="d-flex align-items-center">
                                <h5 className="mb-0 card-title flex-grow-1">Dana Infak/Sedekah</h5>
                            </div>
                        </CardBody>
                        ...
                        <CardBody>
                            ...
                            <table className="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td className="col-6">Penerimaan Infak/Sedekah Tidak Terikat</td>
                            ...
                            <table className="table table-bordered">
                                <tbody>
                                    <tr className="fw-bold">
                                        <td className="col-6">Jumlah Penerimaaan Dana Infak/Sedekah (Sebelum Bagi Hasil)</td>
                            ...
                            <table className="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td className="col-6">Penyaluran Infak/Sedekah Tidak Terikat</td>
                                        <td className="text-end col-3">18,063,192</td>
                                        <td className="text-end col-3">24,185,603</td>
                                    </tr>
                                </tbody>
                            ...
                            <table className="table table-bordered">
                                <tbody>
                                    <tr className="fw-bold">
                                        <td className="col-6">Jumlah Penyaluran Dana Infak/Sedekah</td>
                                        <td className="text-end col-3">6,910,127,553</td>
                                        <td className="text-end col-3">13,684,726,242</td>
                                    </tr>
                                </tbody>
