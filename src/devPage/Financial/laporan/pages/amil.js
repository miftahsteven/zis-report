        ...
        <React.Fragment>
            <div className="page-content">
                <div className="container-fluid">
                    <Breadcrumbs title="LPD Amil" breadcrumbItem="Laporan Perubahan Dana Amil" />
                    <Card>
                        ...
                        <CardBody>
                            ...
                            <table className="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td className="col-6">Bagian Amil dari Dana Infak/Sedekah</td>
                            ...
                            <table className="table table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        <td className="col-6">Beban Sumber Daya Manusia</td>
                                        <td className="text-end col-3">6,005,664,314</td>
                                        <td className="text-end col-3">14,823,489,893</td>
                                    </tr>
                                    <tr>
                                        <td className="col-6">Beban Layanan Kemitraan</td>
                                        <td className="text-end col-3">18,063,192</td>
                                        <td className="text-end col-3">24,185,603</td>
                                    </tr>
                                    <tr>
                                        <td className="col-6">Beban Administrasi dan Umum</td>
                                        <td className="text-end col-3">6,005,664,314</td>
                                        <td className="text-end col-3">14,823,489,893</td>
                                    </tr>
                                    <tr>
                                        <td className="col-6">Beban Penyusutan</td>
                                        <td className="text-end col-3">18,063,192</td>
                                        <td className="text-end col-3">24,185,603</td>
                                    </tr>
                                </tbody>
                        ...
                        <CardBody>
                            <table className="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td className="col-6">Penyesuaian Saldo Tahun Sebelumnya</td>
